...
When using Ollama as a provider with OpenMath Orchestrator agents, you may encounter:
...
- **OpenMath Orchestrator**: Passes through the SDK's behavior (can't fix at this layer)
...
- **OpenMath Orchestrator**: https://github.com/code-yeongyu/oh-my-opencode/issues/1124
