# OpenMath Orchestrator Overview

Learn about OpenMath Orchestrator, the `oh-my-openmath` plugin for OpenCode.
...
## What OpenMath Orchestrator Does for You
...
OpenMath Orchestrator automatically configures models based on your available providers. You don't need to manually specify every model.

### How Models Are Determined

**1. At Installation Time (Interactive Installer)**

When you run `bunx oh-my-openmath install`, the installer asks which providers you have:
...
Based on your answers, it generates `~/.config/opencode/oh-my-openmath.json` with optimal model assignments for each agent and category.
...
- [Ultrawork Manifesto](../ultrawork-manifesto.md) - Philosophy and principles behind OpenMath Orchestrator
