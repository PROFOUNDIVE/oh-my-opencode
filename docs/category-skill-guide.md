...
This document provides a comprehensive guide to the **Category** and **Skill** systems, which form the extensibility core of OpenMath Orchestrator.
...
## 6. Configuration Guide (oh-my-openmath.json)

You can fine-tune categories in `oh-my-openmath.json`.
