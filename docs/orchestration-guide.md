...
This document provides a comprehensive guide to the orchestration system that implements OpenMath Orchestrator's core philosophy: **"Separation of Planning and Execution"**.
...
OpenMath Orchestrator solves this by clearly separating two roles:
...
You can control related features in `oh-my-openmath.json`.
