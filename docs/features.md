# OpenMath Orchestrator Features

---

## Agents: Your AI Team

OpenMath Orchestrator provides 11 specialized AI agents. Each has distinct expertise, optimized models, and tool permissions.
...
Customize agent models, prompts, and permissions in `oh-my-openmath.json`. See [Configuration](configurations.md#agents).
...
OpenMath Orchestrator provides two browser automation providers, configurable via `browser_automation_engine.provider`:
