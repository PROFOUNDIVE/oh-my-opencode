...
describe("getPlatformPackage", () => {
  ...
  test("returns darwin-arm64 for macOS ARM64", () => {
    ...
    expect(result).toBe("oh-my-openmath-darwin-arm64");
  });
  ...
  test("returns darwin-x64 for macOS Intel", () => {
    ...
    // #then returns correct package name
    expect(result).toBe("oh-my-openmath-darwin-x64");
  });
  // #endregion
  ...
  test("returns linux-x64 for Linux x64 with glibc", () => {
    ...
    // #then returns correct package name
    expect(result).toBe("oh-my-openmath-linux-x64");
  });
  ...
  test("returns linux-arm64 for Linux ARM64 with glibc", () => {
    ...
    // #then returns correct package name
    expect(result).toBe("oh-my-openmath-linux-arm64");
  });
  // #endregion
  ...
  test("returns linux-x64-musl for Alpine x64", () => {
    ...
    expect(result).toBe("oh-my-openmath-linux-x64-musl");
  });
  ...
  test("returns linux-arm64-musl for Alpine ARM64", () => {
    ...
    // #then returns correct package name with musl suffix
    expect(result).toBe("oh-my-openmath-linux-arm64-musl");
  });
  // #endregion
  ...
  test("returns windows-x64 for Windows", () => {
    ...
    expect(result).toBe("oh-my-openmath-windows-x64");
  });
  // #endregion
...
describe("getBinaryPath", () => {
  test("returns path without .exe for Unix platforms", () => {
    ...
    const pkg = "oh-my-openmath-darwin-arm64";
    ...
    expect(result).toBe("oh-my-openmath-darwin-arm64/bin/oh-my-openmath");
  });

  test("returns path with .exe for Windows", () => {
    // #given Windows platform package
    const pkg = "oh-my-openmath-windows-x64";
    ...
    expect(result).toBe("oh-my-openmath-windows-x64/bin/oh-my-openmath.exe");
  });

  test("returns path without .exe for Linux", () => {
    // #given Linux platform package
    const pkg = "oh-my-openmath-linux-x64";
    ...
    // #then returns path without extension
    expect(result).toBe("oh-my-openmath-linux-x64/bin/oh-my-openmath");
  });
});
